...
data_type_loader_packet = input(F"{Fore.LIGHTGREEN_EX}TYPE PACKET (OWN1,2,3,4,5)••> {Fore.LIGHTBLUE_EX}").upper()
target_loader = input(f"{Fore.LIGHTGREEN_EX}IP/URL••> {Fore.LIGHTBLUE_EX}")
port_loader = int(input(f"{Fore.LIGHTGREEN_EX}PORT••> {Fore.LIGHTBLUE_EX}"))
time_loader = time.time() + int(input(f"{Fore.LIGHTGREEN_EX}TIME[]••> {Fore.LIGHTBLUE_EX}"))
spam_loader = int(input(f"{Fore.LIGHTGREEN_EX}SPAM THREAD[]••> {Fore.LIGHTBLUE_EX}"))
create_thread = int(input(F"{Fore.LIGHTGREEN_EX}CREATE THREAD[]••> {Fore.LIGHTBLUE_EX}"))
booter_sent = int(input(F"{Fore.LIGHTGREEN_EX}BOOTER SENT[]••> {Fore.YELLOW}"))
...
spam_create_thread = int(input(F"{Fore.GREEN}SPAM CREATE THREAD (DEFAULT=5,15)••> {Fore.YELLOW}"))
print(f"{Fore.LIGHTBLACK_EX}TRYING TO GET IP:PORT {Fore.LIGHTMAGENTA_EX}. . .{Fore.RESET}")
try:
